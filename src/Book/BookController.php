...
namespace H4MSK1\Book;

use Anax\Commons\ContainerInjectableInterface;
use Anax\Commons\ContainerInjectableTrait;
use H4MSK1\Book\HTMLForm\CreateForm;
use H4MSK1\Book\HTMLForm\EditForm;
use H4MSK1\Book\HTMLForm\DeleteForm;
use H4MSK1\Book\HTMLForm\UpdateForm;
